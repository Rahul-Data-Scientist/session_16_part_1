...
with mlflow.start_run():
    ...
    # logging the model
    mlflow.sklearn.log_model(rf, artifact_path = 'random forest')
    # Waise hum yeh bhi kar sakte the - mlflow.log_model(rf, 'random forest')
    ...
    mlflow.set_tag('author', 'nitish sir')
